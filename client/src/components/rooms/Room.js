...
import { AppBar, Avatar, Box, Dialog, IconButton, Rating, Slide, Stack, Toolbar, Tooltip, Typography } from '@mui/material'
...
function Room() {
  ...
  return (
    ...
    >
        <AppBar position='relative'sx={{flexDirection: 'row'}} >
            <Toolbar
            variant="h6"
            component='h3'
            sx={{ml:2, flex: 1}}
